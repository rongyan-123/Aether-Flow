...
export function InitScreen() {
  ...
  const handleStart = async () => {
    ...
    // 临时玩家ID，后续应从后端获取或创建
    const tempPlayerId = 'test_player_001' 
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="男" id="male" className="border-zinc-600 text-amber-500" />
                <Label htmlFor="male" className="text-zinc-300">男</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="女" id="female" className="border-zinc-600 text-amber-500" />
                <Label htmlFor="female" className="text-zinc-300">女</Label>
              </div>
            </RadioGroup>
          </div>
